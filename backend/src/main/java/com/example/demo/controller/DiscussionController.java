...
public class DiscussionController {
    ...
    // Delete discussion method
    @DeleteMapping("/deleteMessage/{messageId}")
    public ResponseEntity<String> deleteDiscussion(@PathVariable Long messageId) {
        boolean isDeleted = discussionService.deleteDiscussionById(messageId);
